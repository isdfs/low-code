...
exports.generateVideoThumbnails = void 0;
/**
 * 生成视频缩略图
 ...
 */
function generateVideoThumbnails(videoElement, captureTimes) {
    return __awaiter(this, void 0, void 0, function () {
        var thumbnails, _i, captureTimes_1, time;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _i++;
                    return [3 /*break*/, 1];
                case 4: return [2 /*return*/, thumbnails];
            }
        });
    });
}
