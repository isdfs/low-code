...
exports.generateMultiResolutionVideo = void 0;
/**
 * 生成多分辨率视频
 ...
 */
function generateMultiResolutionVideo(videoElement, resolutions, mimeType) {
    return __awaiter(this, void 0, void 0, function () {
        var results, _loop_1, _i, resolutions_1, resolution;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    results = [];
                    _loop_1 = function (resolution) {
                        var canvas, ctx, stream, mediaRecorder, chunks;
                    ...
                    _a.label = 1;
                case 1:
                    if (!(_i < resolutions_1.length)) return [3 /*break*/, 4];
...
exports.generateMultiResolutionVideo = generateMultiResolutionVideo;
/*
使用示例:
