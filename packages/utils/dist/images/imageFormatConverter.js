...
var ImageFormatConverter = /** @class */ (function () {
     ...
     */
    ImageFormatConverter.prototype.convert = function (image, options) {
                        ...
                        img.onload = function () {
                            ...
                            canvas.toBlob(function (blob) {
                                if (blob)
                                    ...
                                    reject(new Error('图像格式转换失败'));
                            }, "image/".concat(options.format), options.quality || 0.92);
                        };
...
exports.default = imageFormatConverter;
