...
function mergePDFs(pdfFiles) {
    return __awaiter(this, void 0, void 0, function () {
        var mergedPdf, _i, pdfFiles_1, file, pdf, copiedPages, mergedPdfFile;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    file = pdfFiles_1[_i];
                    return [4 /*yield*/, pdf_lib_1.PDFDocument.load(file)];
                case 3:
                    pdf = _a.sent();
                    return [4 /*yield*/, mergedPdf.copyPages(pdf, pdf.getPageIndices())];
                case 4:
                    copiedPages = _a.sent();
                    copiedPages.forEach(function (page) { return mergedPdf.addPage(page); });
                    _a.label = 5;
                case 5:
                    _i++;
                    return [3 /*break*/, 2];
                case 6: return [4 /*yield*/, mergedPdf.save()];
                case 7:
                    mergedPdfFile = _a.sent();
                    return [2 /*return*/, new Blob([mergedPdfFile], { type: 'application/pdf' })];
            }
        });
    });
}
