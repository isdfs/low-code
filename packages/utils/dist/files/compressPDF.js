 ...
 */
function compressPDF(pdfFile, quality) {
    if (quality === void 0) { quality = 0.8; }
    return __awaiter(this, void 0, void 0, function () {
        var pdf, pages, _i, pages_1, page, _a, width, height, scaleFactor, compressedPdfFile;
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    for (_i = 0, pages_1 = pages; _i < pages_1.length; _i++) {
                        ...
                        scaleFactor = Math.sqrt(quality);
                        page.scaleContent(scaleFactor, scaleFactor);
                        page.setSize(width * scaleFactor, height * scaleFactor);
                    }
                    return [4 /*yield*/, pdf.save()];
                case 2:
                    compressedPdfFile = _b.sent();
                    return [2 /*return*/, new Blob([compressedPdfFile], { type: 'application/pdf' })];
            }
        });
    });
}
