...
var RegexBuilder = /** @class */ (function () {
     ...
     */
    RegexBuilder.prototype.startWith = function (str) {
        this.pattern += "^".concat(str);
        return this;
    };
    /**
     * @description 匹配结尾
     ...
     */
    RegexBuilder.prototype.endWith = function (str) {
        this.pattern += "".concat(str, "$");
        return this;
    };
    /**
     ...
     */
    RegexBuilder.prototype.anyChar = function (count) {
        this.pattern += count ? ".{".concat(count, "}") : '.';
        return this;
    };
    /**
     * @description 匹配数字
     ...
     */
    RegexBuilder.prototype.digit = function (count) {
        this.pattern += count ? "\\d{".concat(count, "}") : '\\d';
        return this;
    };
    /**
     ...
     */
    RegexBuilder.prototype.literal = function (str) {
        this.pattern += str;
        return this;
    };
    /**
     ...
     */
    RegexBuilder.prototype.group = function (builderFn) {
        var groupBuilder = new RegexBuilder();
        builderFn(groupBuilder);
        this.pattern += "(".concat(groupBuilder.build(), ")");
        return this;
    };
    /**
     ...
     */
    RegexBuilder.prototype.build = function () {
