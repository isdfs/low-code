...
exports.requestPermission = exports.checkPermission = void 0;
/**
 * 检测和请求浏览器权限。
 *
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_1 = _a.sent();
                    throw new Error("\u65E0\u6CD5\u68C0\u6D4B\u6743\u9650\u72B6\u6001: ".concat(error_1.message));
...
function requestPermission(permissionName) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(permissionName === 'notifications')) return [3 /*break*/, 2];
                    return [4 /*yield*/, Notification.requestPermission()];
                case 1:
                    result = _a.sent();
                    return [2 /*return*/, { state: result }];
                case 2: return [4 /*yield*/, checkPermission(permissionName)];
