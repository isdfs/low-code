...
exports.removeNavigationInterceptor = exports.addNavigationInterceptor = void 0;
/**
 * 添加导航拦截器。
 *
 ...
 * ```
 */
function addNavigationInterceptor(callback) {
    window.addEventListener('beforeunload', callback);
}
exports.addNavigationInterceptor = addNavigationInterceptor;
/**
* 移除导航拦截器。
*
* 该方法用于移除之前添加的导航拦截器。
...
* ```
*/
function removeNavigationInterceptor(callback) {
    window.removeEventListener('beforeunload', callback);
}
exports.removeNavigationInterceptor = removeNavigationInterceptor;
