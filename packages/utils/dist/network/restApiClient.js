...
var RestApiClient = /** @class */ (function () {
     ...
     * @returns 返回API响应结果。
     */
    RestApiClient.prototype.get = function (endpoint, params) {
     ...
     * @returns 返回API响应结果。
     */
    RestApiClient.prototype.post = function (endpoint, body) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
     ...
     * @returns 返回API响应结果。
     */
    RestApiClient.prototype.put = function (endpoint, body) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
     ...
     * @returns 返回API响应结果。
     */
    RestApiClient.prototype.delete = function (endpoint) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    RestApiClient.prototype.request = function (url, method, body) {
        return __awaiter(this, void 0, void 0, function () {
            var config, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
