 ...
 * ```
 */
export function addNavigationInterceptor(callback: (event: BeforeUnloadEvent) => string | void): void {
...
* ```
*/
export function removeNavigationInterceptor(callback: (event: BeforeUnloadEvent) => string | void): void {
