 ...
 * ```
 */
export function monitorDeviceOrientation(callback: (event: DeviceOrientationEvent) => void): void {
...
* ```
*/
export function stopDeviceOrientationMonitoring(callback: (event: DeviceOrientationEvent) => void): void {
